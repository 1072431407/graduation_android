...
public class SubjectView1 extends LinearLayout {
    ...
    public SubjectView1(Context context) {
        super(context);
        this.context = context;
        LayoutInflater.from(context).inflate(R.layout.subject_message_1,this);
        init();
        initData();
    }
    ...
    private void initData() {
        ...
        StatisticsDataRequest request = StatisticsDataRequest.newBuilder()
                .setUserId(userId)
                .setRequestType(StatisticsDataRequest.REQUEST_TYPE.SUBJECT_1)
                .build();
    ...
    public SubjectView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    public SubjectView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
